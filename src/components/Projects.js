...
export default function Projects() {
    ...
    return (
        <div className="arrowWrapper">
            ...
            <Link className="bottomArrow" onClick={() => window.scrollBy({top: window.innerHeight, behavior: "smooth"})}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#dfdedf" class="bi bi-arrow-down" viewBox="0 0 16 16">
